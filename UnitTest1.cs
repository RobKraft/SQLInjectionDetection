...
namespace UnitTestProject1
{
	...
	public class UnitTest1
	{
		...
		public void AllTheTests()
		{
			...
			Assert.ThrowsException<ConsoleApp1.SQLFormattingException>(() => n = "2/31/2018".FormatDateForSQL());
			Assert.ThrowsException<ConsoleApp1.SQLFormattingException>(() => n = "1".FormatDateForSQL());
			n = "1".FormatNumberForSQL();
			n = "1.1".FormatNumberForSQL();
			Assert.ThrowsException<ConsoleApp1.SQLFormattingException>(() => n = " ".FormatNumberForSQL());
			Assert.ThrowsException<ConsoleApp1.SQLFormattingException>(() => n = "or 1=1".FormatNumberForSQL());
			n = "true".FormatBooleanForSQL();
			n = "True".FormatBooleanForSQL();
			n = "TRuE".FormatBooleanForSQL();
			n = "Yes".FormatBooleanForSQL();
			Assert.ThrowsException<ConsoleApp1.SQLFormattingException>(() => n = "1".FormatBooleanForSQL());
			Assert.ThrowsException<ConsoleApp1.SQLFormattingException>(() => n = "3".FormatBooleanForSQL());
			Assert.ThrowsException<ConsoleApp1.SQLFormattingException>(() => n = "roger".FormatBooleanForSQL());
			Assert.ThrowsException<ConsoleApp1.SQLFormattingException>(() => n = " ".FormatBooleanForSQL());
